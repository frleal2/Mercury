...
# Use DATABASE_URL if set (for connecting to production PostgreSQL), otherwise SQLite
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # For any custom static files
]
...
if USE_S3:
    ...
    # Use signed URLs for private files (required for trip documents photo access)
